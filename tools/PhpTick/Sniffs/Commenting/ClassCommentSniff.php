...
if (class_exists('PhpTick_Sniffs_Commenting_FileCommentSniff', true) === false) {
	$error = 'Class PhpTick_Sniffs_Commenting_FileCommentSniff not found';
	throw new PHP_CodeSniffer_Exception($error);
}
 ...
 * @link      http://pear.php.net/package/PHP_CodeSniffer
 */
class PhpTick_Sniffs_Commenting_ClassCommentSniff extends PhpTick_Sniffs_Commenting_FileCommentSniff {
