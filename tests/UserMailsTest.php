...
class UserMailsTest extends PHPUnit_Framework_TestCase
{
	...
	public function storeNew()
	{
		...
		$this->assertEquals(5, $userMails->get()->whereEquals('userId', 5)->whereEquals('mailId', 5)->current()->getUserId());
	}
	...
	public function remove()
	{
		...
		$this->assertEquals(0, $userMails->get()->whereEquals('userId', 1)->whereEquals('mailId', 1)->count());
	}
	...
	public function update()
	{
		...
		$userMails->update(array('userId' => 1, 'mailId' => 1));
		$userMails = new UserMails();
		$this->assertEquals(1, $userMails->get()->whereEquals('userId', 6)->whereEquals('mailId', 6)->count());
	}
